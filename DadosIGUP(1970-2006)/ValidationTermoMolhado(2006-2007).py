...
onlyfiles = [f for f in listdir('TermoMolhado(2006-2007)') if isfile(join('TermoMolhado(2006-2007)', f))]
...
for file in onlyfiles:
    ...
    file='TermoMolhado(2006-2007)/' + file
                ...
                for index, cell in enumerate(row):
                    ...
                    if(index>=24 or index <30): 
                        try:
                            value=float(cell.value)
                            if(value >= temp_max or value < temp_min):
                                print('Valor Suspeito Temperatura: ' + str(value) + ' - ' + str(ws) + ' Dia: ' + str(dia))
