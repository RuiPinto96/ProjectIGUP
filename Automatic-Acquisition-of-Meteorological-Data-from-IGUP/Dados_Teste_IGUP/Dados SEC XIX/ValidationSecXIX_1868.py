...
onlyfiles = [f for f in listdir('1868') if isfile(join('1868', f))]
...
for file in onlyfiles:
    ...
    for index3,ws in enumerate(wb.worksheets):
        ...
        #Mes com 31 dias
        if ws==wb.worksheets[0] or ws==wb.worksheets[2] or ws==wb.worksheets[4] or ws==wb.worksheets[6] or ws==wb.worksheets[7] or ws==wb.worksheets[9]:
            if(ws.cell(row=2, column=13).value == None):
                minr=22
                maxc=32
                maxr=52
