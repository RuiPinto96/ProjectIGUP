                ...
                for index, cell in enumerate(row):
                    ...
                    if(index<28 and index>=0):
                        if(index==1 or index==5 or index==6 or index==14 or index==17 or index==20):
                            ...
                            #print ut
                        if(index==2 or index==7 or index==8 or index==15 or index==18  or index==21):
                            hora = 12
                            try:
                                value=float(cell)
